...
//	pid_blance.err_last = pid_blance.err;
//	 
//	if (pid_blance.output_val>=200) return 200;
//	else if (pid_blance.output_val<=-200) return -200;
...
float blance_pid_hor(float Kp, float Ki, float Kd, float angle)
{
	...
	pid_blance.Kd = Kd;
	pid_blance.err = angle;
	pid_blance.err_last=0;
	pid_blance.err_prev=0;
	pid_blance.output_val = pid_blance.Kp * (pid_blance.err-pid_blance.err_last)+
	                        pid_blance.Ki * pid_blance.err +
													pid_blance.Kd * (pid_blance.err-2*pid_blance.err_last+pid_blance.err_prev);
	pid_blance.err_prev = pid_blance.err_last;
	pid_blance.err_last = pid_blance.err;
